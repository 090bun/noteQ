...
export default function AnalysisOverlay({ 
  ...
  return (
    <>
      <div 
        className={`${styles['overlay-backdrop']} ${isOpen ? styles.active : ''}`} 
        onClick={onClose}
      />
      
      <div className={`${styles['analysis-overlay']} ${isOpen ? styles.active : ''}`}>
        ...
        <div className={styles['analysis-content']}>
          <div className={styles['chat-messages']}>
            ...
            <div className={`${styles.message} ${styles.placeholder}`}>
              <div className={styles['placeholder-icon']} onClick={onOpenAnalysisFavoriteModal}>+</div>
              AI的回答在這裡
            </div>
          </div>
        </div>
        ...
        <div className={styles['analysis-input']}>
          <span className={styles['add-icon']} onClick={onOpenAnalysisFullFavoriteModal}>+</span>
          <input 
            type="text" 
